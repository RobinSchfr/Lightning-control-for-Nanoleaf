...
class Ui_EffectOptionsTab:
    def __init__(self, eventHandler):
        ...
        self.evolutionSpeed = Ui_AnnotatedSlider(min=1, max=100, value=50, description='Evolution Speed:', effectFactory=self.effectFactory)
        self.scale = Ui_AnnotatedSlider(min=1, max=100, value=50, description='Scale:', effectFactory=self.effectFactory)
        self.stretch = Ui_AnnotatedSlider(min=1, max=100, value=50, description='Stretch:', effectFactory=self.effectFactory)
